...
$a = mysqli_query("SELECT * FROM tbl_siswa WHERE  nis = '$_POST[user]'");
...
if (isset($_POST['login'])) {
    if ($c > 0) {
        if ($_POST['pass'] == $_POST['user']) {
            ...
            echo "<script>alert('Selamat Datang $nama');document.location.href='hal_peserta-didik.php?menu=home'</script>";
        } else {
